...
MODULES		= driver utils bosch user
EXTRA_INCDIR    = driver utils bosch

# libraries used in this project, mainly provided by the SDK
LIBS		= c gcc hal pp phy net80211 lwip wpa crypto ssl driver upgrade json main
...
LD_SCRIPT	= eagle.rom.addr.v6.ld eagle.app.v6.ld
#eagle.app.v6.ld
